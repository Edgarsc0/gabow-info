      ...
      <nav className="bg-gray-900 fixed w-full z-20 top-0 start-0 shadow-xl">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div
            ...
            id="navbar-sticky"
          >
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-bold border border-gray-100 rounded-lg bg-[#0B132B] md:space-x-8 md:flex-row md:mt-0 md:border-0 md:bg-transparent">
