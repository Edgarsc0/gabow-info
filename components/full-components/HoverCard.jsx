        ...
        return (
            <HoverCard>
                <HoverCardTrigger asChild>
                    <Button
                        type="button"
                        className="text-white bg-yellow-500 hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-bold rounded-lg text-sm px-4 py-2 transition-all"
                    >
                        Contacto
                    </Button>
                </HoverCardTrigger>
